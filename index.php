    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
       ...
       <?php foreach ($experience  as $key => $exp): ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$exp['name']?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$exp['data']?><span class="w3-tag w3-teal w3-round"><?php if ($key == 0):?> current <?php endif; ?></span></h6>
          <p><?=$exp['description']?></p>
          <hr>
        </div>
        <?php endforeach ?>
